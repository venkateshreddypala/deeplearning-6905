In order to execute CNN, make sure you have Python 3.5. It won't run in 3.6 in windows (don't know if it will work in Macbook or not). It has to do with array of PIL image. Install Pillow using pip 
